...
# Fake users with bets
INSERT INTO `mydb`.`user`( Id, points, `right`, wrong, currentBet, amount, teamBet) values
("Bob",    750,  14, 12, 2020101, 50,   "London Spitfire"),
("Olivia", 1000, 19, 2,  1010103, 250,  "Fnatic"),
("Emma",   1275, 14, 12, 1010106, 1200, "Team SoloMid"),
("Noah",   50,   12,  20, 1010102, 15,   "Afreeca Freecs"),
("James",  750,  12, 9,  2020106, 100,  "Houston Outlaws"),
("Obama",  4444, 50, 0,  2020104, 2572, "Shanghai Dragons");

INSERT INTO mydb.user(Id, points, `right`, wrong) values
("Lol",        5,    0,   25),
("Kanye 2020", 2020, 150, 31),
("Lebron",     124,  3,   6),
("Bigduck",    843,  249, 275),
("King",       1600, 41,  9);
