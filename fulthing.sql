...
("Jakub Skurzyński"   ,"Team Vitality", "jactroll",  3.1, "Poland"),
...
("Phạm Minh Lộc"       ,"Phong Vu Buffalo", "Zeros",   3.3, "Vietnam"),
("Bùi Hoàng Sơn Vương" ,"Phong Vu Buffalo", "XuHao",   3.1, "Vietnam"),
("Võ Thành Luân"       ,"Phong Vu Buffalo", "Naul",    5.2, "Vietnam"),
("Đặng Ngọc Tài"       ,"Phong Vu Buffalo", "BigKoro", 5.0, "Vietnam"),
("Nguyễn Hải Trung"    ,"Phong Vu Buffalo", "Palette", 4.9, "Vietnam"),
...
("Kevin Lindström", "Florida Mayhem", "TviQ", 1.78, "Sweden"),
...
("João Pedro Goes Telles", "LA Gladiators", "Hydration", 2.48, "USA"),
