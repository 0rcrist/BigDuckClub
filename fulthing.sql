...
SELECT * FROM players WHERE name = "andy hoang";

# For all overwatch games
Select * FROM mydb.match WHERE idmatch > "2020000";

# For all Lol games 
Select * FROM mydb.match WHERE idmatch > 1010000 AND idMatch < 2020000;

Select teamA, teamB, coalesce(Winner, ""), coalesce(scoreA, ""), coalesce(scoreB, ""),
happend, tournament FROM mydb.match WHERE happend = 0;
